...
const Beats = () => {
  ...
  return (
    <div className="flex flex-wrap justify-around">
      {(isBeatsLoading ? [...Array(5)] : beats.items).map((obj, index) => isBeatsLoading ?
        (<SkeletonBeat key={index}/>)
        :
        (<div key={obj._id} className="flex flex-col border border-[#151719] rounded-md w-1/5 p-4 hover:border-[#2c2b2b] hover:bg-[#3c3b3b]">
          <Image
            src="/test2.jpeg"
            alt="beat cover"
            width={260}
          ...
          <div className="text-md mt-4">
            <div className="flex gap-2 items-center">
              ...
              <div
                className="flex items-center gap-1 px-2 bg-[#F75380] border border-[#F75380] rounded-full hover:border-white">
                <Image
