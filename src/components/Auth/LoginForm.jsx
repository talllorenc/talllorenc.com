...
const LoginForm = ({closePopup}) => {
        const {values, handleChange, touched, handleBlur, handleSubmit, errors, isValid} =
            useFormik({
                initialValues: {
                    login: "",
                    password: "",
        ...
        return (
            <div className="flex flex-col gap-8">
                <div className="flex flex-col">
                    ...
                    <form method="POST" onSubmit={handleSubmit} className="p-2 min-w-[300px] space-y-6 flex flex-col items-center">
                        ...
                        <div className="flex justify-between w-full">
                            <button
                                type="submit"
                                className="bg-[#F75370] border-2 border-[#F75370] p-1 w-[130px] rounded-lg hover:border-white">Log
                                in
                            </button>
                            <Link onClick={closePopup} href="/register"
                                  className="text-center border-[2px] border-[#F75370] p-1 w-[130px] rounded-lg hover:bg-[#F75370]">Register</Link>
                        </div>
                    </form>
                </div>
                <SocialAuth/>
